          ...
          <div className={styles.formGroupprofile}>
            ...
            <div className={styles.profileContainer}>
              {profilePictureImagePreview ? (
                ...
                <div className={styles.defaultPicture}>N</div> // Default avatar
              )}
            ...
            <div className={styles.ShippingAddressescontainer}>
              {savedShippingAddresses.map((address, index) => (
                <div key={index} className={styles.addressContainer}>
                  ...
                  {/* Repeat similar code for all fields like address2, city, phoneNo, etc. */}
                </div>
              ))}
            </div>

            <button type="button" onClick={addNewAddress} className={styles.addAddressButton}>
