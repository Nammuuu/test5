...
// export const cloudinaryUploaduserprofilepic = (fileBuffer, folder) => {
...
export const cloudinaryUploaduserprofilepic = async (fileBase64, folder) => {
  try {
    ...
    console.error("Cloudinary upload error:", error);
    if (error.response) {
      console.error("Cloudinary response error details:", error.response.body);
    }
    throw new Error("Cloudinary upload error");
  }
};
